    ...
    public class BookingController : Controller
    {
        ...
        public IActionResult FinalizeBooking(Booking booking)
        {
           ...
           _bookingService.CreateBooking(booking);
            ...
            //uncomment below 5 lines when stripe account is active
            ...
            //comment below after uncomment above 5 lines
        ...
        public IActionResult GenerateInvoice(int id, string downloadType)
        {
            ...
            if (bookingFromDB.VillaNumber > 0)
            {
                ...
                row2.Cells[1].AddParagraph().AppendText("Villa Number - "+bookingFromDB.VillaNumber);
        ...
        {
            _bookingService.UpdateStatus(booking.Id, SD.Status_CheckedIn, booking.VillaNumber);
        ...
        {
            _bookingService.UpdateStatus(booking.Id, SD.Status_Cancelled, 0);
        ...
        public IActionResult BookingConfirmation(int bookingId)
        {
            ...
            {
                //this is the pending order, we need to confirm if payment was successful
                //var service = new SessionService();
                //Session session = service.Get(bookingFromDB.StripeSessionId);
                //if (session.PaymentStatus == "paid")
                //{
                    _bookingService.UpdateStatus(bookingFromDB.Id, SD.Status_Approved, 0);
